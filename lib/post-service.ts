...
export const uploadVideo = async (request: UploadRequest, onDownloadProgress: (progressEvent: AxiosProgressEvent) => void) => {
...
export const uploadImage = async (request: UploadRequest, onUploadProgress: (progressEvent: AxiosProgressEvent) => void) => {
    try {
...
export const postVideoToYoutube = async (request: YoutubePostRequest): Promise<any> => {
    try {
...
export const postVideoToInstagram = async (request: InstagramPostRequest) => {
    try {
